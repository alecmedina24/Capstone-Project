        ...
        builder.setPositiveButton(context.getString(R.string.positive_button), new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (!exercise.equals("")) {
                    ...
                    prefEditor.putString(AddExerciseDialog.REPEAT_EXERCISE_PREF, exercise);
                    prefEditor.putString(AddExerciseDialog.REPEAT_WEIGHT_PREF, weight);
                    prefEditor.putString(AddExerciseDialog.REPEAT_REPS_PREF, reps);
                    prefEditor.commit();
